  ...
  },
  {
    ...
    opts = function(_, opts)
      ...
      opts.defaults = {
        ...
        prompt_prefix = "> ", -- Set the prompt to junvim-telescope/telescope.nvimst ">"
        layout_strategy = "horizontal", -- Use horizontal layout
        layout_config = {
          prompt_position = "top", -- Set the prompt position to the bottom
        },
        ...
        --   preview = { "─", "│", "-", "│", "╭", "╮", "╯", "╰" }, -- Borders for the preview window
        -- },
        mappings = {
          i = {
